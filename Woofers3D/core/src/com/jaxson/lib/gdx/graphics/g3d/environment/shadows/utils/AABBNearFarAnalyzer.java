...
/**
 * Compute near and far plane based on renderable providers passed in
 * constructor. Renderable providers array should contains only
...
public class AABBNearFarAnalyzer implements NearFarAnalyzer
{
	...
	/**
	 * Near and far initialization before computation. You should put the same
	 * values as the main camera
	 */
	...
	@Override
	public <T extends RenderableProvider> void analyze(BaseLight light,
			Camera camera, Iterable<T> renderableProviders)
	{
		...
		for (Renderable renderable: renderables)
		{
			...
			if (camera.frustum
					.sphereInFrustum(tmpV, renderable.meshPart.radius))
			{
	...
	protected <T extends RenderableProvider> void getRenderables(
			Iterable<T> renderableProviders)
	{
