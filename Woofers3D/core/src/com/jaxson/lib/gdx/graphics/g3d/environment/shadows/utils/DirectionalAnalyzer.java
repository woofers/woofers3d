...
/**
 * Directional Analyzer computes the camera's properties needed by directional
 * light. Implementation should use main camera
...
{
	/**
	 * Compute the camera dimension based on directional light. Camera should be
