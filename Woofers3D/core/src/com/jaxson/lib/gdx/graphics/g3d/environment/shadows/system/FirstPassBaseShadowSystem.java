...
/**
 * FirstPassBaseShadowSystem assumes that the first pass renders all depth map
 * in one texture.
 * @author realitix
 */
public abstract class FirstPassBaseShadowSystem extends BaseShadowSystem
{
	...
	public FirstPassBaseShadowSystem(NearFarAnalyzer nearFarAnalyzer,
	...
	{
		frameBuffers[FIRST_PASS] = new FrameBuffer(Pixmap.Format.RGBA8888,
				allocator.getWidth(),
				allocator.getHeight(),
				true);
	}
