...
/**
 * This shader is used by the classical shadow system. This shader supports
...
public class MainShader extends DefaultShader
{
	...
	public static class Setters extends DefaultShader.Setters
	{
		...
		public final static Setter resolution = new GlobalSetter()
		{
					...
					Renderable renderable, Attributes combinedAttributes)
			{
				...
				shader.set(
						inputID, (float) Gdx.graphics.getBackBufferWidth(),
	...
	public static String getDefaultFragmentShader()
	{
		if (defaultFragmentShader == null)
			defaultFragmentShader =	new GdxFile("shaders/classical/main.fragment.glsl").readString();
	...
	public static String getDefaultVertexShader()
	{
		if (defaultVertexShader == null)
			defaultVertexShader = new GdxFile("shaders/classical/main.vertex.glsl").readString();
