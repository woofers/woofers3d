...
/**
 * Classical shadow system uses shadow accumulation method. For each light, a
 * depth map is generated and a second pass accumulate
 * the shadows. Obviously, the second pass must use the same lighting system as
 * the main rendering pass. Compared to Realistic
...
public class ClassicalShadowSystem extends FirstPassBaseShadowSystem
{
	...
	public ClassicalShadowSystem(NearFarAnalyzer nearFarAnalyzer,
	...
	{
		frameBuffers[SECOND_PASS] = new FrameBuffer(Pixmap.Format.RGBA8888,
				Gdx.graphics.getBackBufferWidth(),
				Gdx.graphics.getBackBufferHeight(),
				true);
		passShaderProviders[SECOND_PASS]
				= new Pass2ShaderProvider(new Pass2Shader.Config(this));
	}
