...
public class MyColor
{
	...
	public static final MyColor BRIGHT_GREEN = new MyColor(IndexedColors.BRIGHT_GREEN);
	...
	public static final MyColor LIGHT_GRAY = new MyColor(IndexedColors.GREY_25_PERCENT);
	public static final MyColor GRAY = new MyColor(IndexedColors.GREY_50_PERCENT);
	public static final MyColor LAVENDER = new MyColor(IndexedColors.CORNFLOWER_BLUE);
	public static final MyColor WINE = new MyColor(IndexedColors.MAROON);
	public static final MyColor LEMON = new MyColor(IndexedColors.LEMON_CHIFFON);
	...
	public static final MyColor LIGHT_LAVENDER = new MyColor(IndexedColors.LIGHT_CORNFLOWER_BLUE);
	public static final MyColor SKY = new MyColor(IndexedColors.SKY_BLUE);
	public static final MyColor LIGHT_SKY = new MyColor(IndexedColors.LIGHT_TURQUOISE);
	public static final MyColor LIGHT_GREEN = new MyColor(IndexedColors.LIGHT_GREEN);
	public static final MyColor LIGHT_YELLOW = new MyColor(IndexedColors.LIGHT_YELLOW);
	public static final MyColor PALE_BLUE = new MyColor(IndexedColors.PALE_BLUE);
	public static final MyColor ROSE = new MyColor(IndexedColors.ROSE);
	public static final MyColor DARK_LAVENDER = new MyColor(IndexedColors.LAVENDER);
	public static final MyColor TAN = new MyColor(IndexedColors.TAN);
	public static final MyColor MILD_BLUE = new MyColor(IndexedColors.LIGHT_BLUE);
	...
	public static final MyColor DARK_PURPLE = new MyColor(IndexedColors.BLUE_GREY);
	public static final MyColor MILD_GRAY = new MyColor(IndexedColors.GREY_40_PERCENT);
	public static final MyColor DARK_TEAL = new MyColor(IndexedColors.DARK_TEAL);
	public static final MyColor SEA_GREEN = new MyColor(IndexedColors.SEA_GREEN);
	public static final MyColor DARK_GREEN = new MyColor(IndexedColors.DARK_GREEN);
	public static final MyColor OLIVE_GREEN = new MyColor(IndexedColors.OLIVE_GREEN);
	...
	public static final MyColor CHARCOAL = new MyColor(IndexedColors.GREY_80_PERCENT);
